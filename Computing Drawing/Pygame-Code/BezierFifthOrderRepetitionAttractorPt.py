...
while (1==1):
    ...
    while y <= windowY:
        ...
        attract_factor = (distance(attractorX, attractorY, attractorX, y)+1)**(-.1) * radius * 10
        ...
        # Set Control Pts
        control_pointlist = [(0,y), (attractorX, y_adjusted), (windowX-100,y), (windowX, y)]

        # pygame.draw.circle(screen, gray, (control_pointlist[0][0],control_pointlist[0][1]), 5, 0)
        # pygame.draw.circle(screen, gray, (control_pointlist[1][0],control_pointlist[1][1]), 5, 0)
        # pygame.draw.circle(screen, gray, (control_pointlist[2][0],control_pointlist[2][1]), 5, 0)
        ...
        connect_points(pointlist, 2)

    pygame.draw.circle(screen, black, attractor, 3, 0)
    pygame.draw.circle(screen, black, attractor, 6, 1)
    pygame.draw.circle(screen, black, attractor, 10, 1)
    pygame.draw.circle(screen, black, attractor, 15, 1)
